...
export default function HomeScreen() {
  ...
  const services = [
    { id: '1', name: 'Salon for women', image: require('./assets/womensalon.jpg') },
    { id: '2', name: 'Salon Prime for kids & men', image: require('./assets/salonmen.webp') },
    { id: '3', name: 'AC & Appliance Repair', image: require('./assets/ac_appliance.jpg') },
    { id: '4', name: 'Cleaning', image: require('./assets/cleaning.jpg') },
    { id: '5', name: 'Electrician', image: require('./assets/electrician.jpg') },
    { id: '6', name: 'Pest Control', image: require('./assets/pest_control.avif') },
  ];

  const topCategories = [
    { id: '1', title: 'Ac-appliances', image: require('./assets/ac_appliance.jpg') },
    { id: '2', title: 'Technicians', image: require('./assets/technician.jpg') },
    { id: '3', title: 'Salon', image: require('./assets/salonmen.webp') },
    { id: '4', title: 'Pest Control', image: require('./assets/pest_control.avif') },
  ];
  useEffect(() => {
  (async () => {
            ...
            <View>
              ...
              {showDropdown && (
                <View style={styles.dropdownMenu}>
                  ...
                  <TouchableOpacity style={styles.dropdownItem} onPress={handleEmployeeLoginPress}>
                    <Text style={styles.dropdownText}>
                      {isEmpLoggedIn ? 'Employee Logout' : 'Employee Login'}
                    </Text>
                  </TouchableOpacity>
                </View>
              )}
